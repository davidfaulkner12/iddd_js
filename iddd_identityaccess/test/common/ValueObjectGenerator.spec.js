...
describe("ValueObjectGenerator", function() {
  ...
  it("Should enforce validation rules", function() {
    ...
    try {
      let myFoo = new Foo("avalue", "bvalue", "cvalue")
    } catch (err) {
      errorOccurred = true
    }
  ...
  it("Should allow for a custom validation method from a superclass", function() {
    let Foo = ValueObjectGenerator.generate({
      name: "Foo",
      ...
      props: [{
        ...
        validate: function(value) {
          console.log("Here", Object.getPrototypeOf(Object.getPrototypeOf(this)).assertArgumentNotEmpty)
