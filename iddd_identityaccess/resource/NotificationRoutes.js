...
const notificationLogResponse = (notificationLog, request, current) => {
  let log =
  ...
  let response = Serializer.generateExternalRepresentation(log)
...
const getNotificationsForId = (request, reply) => {
  ...
  let notificationLog = ApplicationServiceRegistry
